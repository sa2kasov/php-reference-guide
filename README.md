...
Области видимости свойств, методов или констант могут быть определены как `public`, `private` или `protected`.

* `public` – доступ к свойству или методу разрешён отовсюду;
* `protected` – разрешает доступ в самом классе, а также в наследуемых и родительских классах;
* `private` – ограничивает область видимости тем классом, в котором он объявлен.
